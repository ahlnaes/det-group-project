...
The problem: computing this naively requires N multiplications per bin, and there are N bins. That's O(N²) operations. For N=1024 that's ~1 million operations per frame. This is where [FFT](Fast%20Fourier%20Transform.md) comes in.
